...
const canonicalPath = "/insights/machine-learning";
const siteBaseUrl = siteContent.person.website.replace(/\/$/, "");
...
export default function MachineLearningPage() {
  const articleSchema = {
    ...
    description:
      "Explore machine learning concepts, supervised & unsupervised learning, and hybrid AI approaches.",
    image: [`${siteBaseUrl}/images/AI.jpg`],
          ...
          <div className="sticky top-20 space-y-4">
            ...
            <div className="rounded-lg border border-border/40 bg-card/50 p-4">
              ...
              <div className="space-y-2">
                <a href={`https://twitter.com/intent/tweet?text=Machine Learning Fundamentals&url=${canonicalUrl}`} target="_blank" rel="noreferrer" className="block text-xs text-muted-foreground hover:text-primary transition-colors">
                  → Share on Twitter
                </a>
                <a href={`https://www.linkedin.com/sharing/share-offsite/?url=${canonicalUrl}`} target="_blank" rel="noreferrer" className="block text-xs text-muted-foreground hover:text-primary transition-colors">
                  → Share on LinkedIn
                </a>
                <a href={`mailto:?subject=Check out: Machine Learning Fundamentals&body=${canonicalUrl}`} className="block text-xs text-muted-foreground hover:text-primary transition-colors">
                  → Share via Email
                </a>
              </div>
            </div>
