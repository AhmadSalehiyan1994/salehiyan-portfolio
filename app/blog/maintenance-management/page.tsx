...
export default function MaintenanceManagementPage() {
  const articleSchema = {
    ...
    description:
      "Complete guide to maintenance management strategies, KPIs, predictive maintenance, and operational reliability.",
    image: [`${siteBaseUrl}/images/baner.png`],
          ...
          <div className="sticky top-20 space-y-4">
            ...
            <div className="rounded-lg border border-border/40 bg-card/50 p-4">
              ...
              <div className="space-y-2">
                <a
                  href={`https://twitter.com/intent/tweet?text=Maintenance Management Fundamentals&url=${canonicalUrl}`}
                  target="_blank"
                  rel="noreferrer"
                ...
                <a
                  href={`mailto:?subject=Check out: Maintenance Management Fundamentals&body=${canonicalUrl}`}
                  className="block text-xs text-muted-foreground hover:text-primary transition-colors"
                >
                  → Share via Email
                </a>
      ...
      <section className="border-t border-border/40 bg-background/50 px-6 py-16">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <Link href="/insights/machine-learning" className="group">
            ...
            <Link href="/insights/integer-programming" className="group">
              <Card className="h-full hover:border-primary transition-colors">
                <div className="aspect-video bg-muted overflow-hidden rounded-t-lg">
                  <Image
                    src="/images/INT.png"
