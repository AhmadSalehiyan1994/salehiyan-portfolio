...
export default function IntegerProgrammingPage() {
  const articleSchema = {
    ...
    description:
      "Master integer programming optimization. Learn formulation, solution methods, real-world applications, and how to solve complex planning problems.",
    image: [`${siteBaseUrl}/images/INT.png`],
          ...
          <div className="sticky top-20 space-y-4">
            ...
            <div className="rounded-lg border border-border/40 bg-card/50 p-4">
              ...
              <div className="space-y-2">
                <a
                  href={`https://twitter.com/intent/tweet?text=Integer Programming Fundamentals&url=${canonicalUrl}`}
                  target="_blank"
                  rel="noreferrer"
                ...
                <a
                  href={`mailto:?subject=Check out: Integer Programming Fundamentals&body=${canonicalUrl}`}
                  className="block text-xs text-muted-foreground hover:text-primary transition-colors"
                >
                  → Share via Email
                </a>
      ...
      <section className="border-t border-border/40 bg-background/50 px-6 py-16">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <Link href="/insights/maintenance-management" className="group">
              <Card className="h-full hover:border-primary transition-colors">
                <div className="aspect-video bg-muted overflow-hidden rounded-t-lg">
                  <Image
